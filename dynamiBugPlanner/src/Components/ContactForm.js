			...
			<div>
				<form>
					<div>
						...
						<input id='senderEmail' value={senderEmail} onChange={(event) => { setSenderEmail(event.target.value) }} type="email" />
					</div>
					<div>
						<label htmlFor='receiverEmail'>Reciever: </label>
						<input id='receiverEmail' value={receiverEmail} onChange={(event) => { setReceiverEmail(event.target.value) }} type="email" />
					</div>
					<div>
						<label htmlFor='messageTitle'>Title: </label>
						<input id='messageTitle' value={messageTitle} onChange={(event) => { setMessageTitle(event.target.value) }} type="text" />
					</div>
					<div>
						<label htmlFor='messageBody'>Message: </label>
                        <textarea id='messageBody' value={messageBody} onChange={(event) => { setMessageBody(event.target.value) }} />
					</div>
				</form>
			</div>
		</>
